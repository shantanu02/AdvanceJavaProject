...
@Service
public class FacultyValidatorRegistration implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (user.getFacultyPhone() != null) {
			if (user.getFacultyPhone().length() < 10) {
				errors.rejectValue("facultyPhone", "passKey", "phone number should contain 10 digits");
			}
